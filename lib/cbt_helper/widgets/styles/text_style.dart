...
extension TextStylesHandler on TStyle {
  ...
  TextStyle styleWith(
      {Color? color = CodebrightColor.fontColor, String fontFamily = "", FontWeight? fontWeight = FontWeight.normal}) {
...
abstract class _TextStyles implements CodebrightColor, AppFontsNeo {
  ...
  static final Map<TStyle, TextStyle> mobileStyles = {
    ...
    TStyle.f20_R: TextStyle(
      fontFamily: AppFontsNeo.montserratRegular,
      fontSize: 20 + extraSize,
      color: CodebrightColor.fontColor,
    ),
    TStyle.f22_R: TextStyle(
      fontFamily: AppFontsNeo.montserratRegular,
      fontSize: 22 + extraSize,
      color: CodebrightColor.fontColor,
    ),
    TStyle.f24_R: TextStyle(
      fontFamily: AppFontsNeo.montserratRegular,
      fontSize: 24 + extraSize,
      color: CodebrightColor.fontColor,
    ),
    TStyle.f26_R: TextStyle(
      fontFamily: AppFontsNeo.montserratRegular,
      fontSize: 26 + extraSize,
      color: CodebrightColor.fontColor,
    ),
    TStyle.f28_R: TextStyle(
      fontFamily: AppFontsNeo.montserratRegular,
      fontSize: 28 + extraSize,
      color: CodebrightColor.fontColor,
    ),
    TStyle.f30_R: TextStyle(
      fontFamily: AppFontsNeo.montserratRegular,
      fontSize: 30 + extraSize,
      color: CodebrightColor.fontColor,
    ),
  };
}
